# PintarConGestos.py - Pintura en el aire con gestos de la mano
# Este script permite dibujar en una pantalla virtual usando gestos detectados por MediaPipe.
# Incluye paleta de colores, borrador, y gestos para limpiar el lienzo.
import cv2
